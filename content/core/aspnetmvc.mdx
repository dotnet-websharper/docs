---
title: Using WebSharper with ASP.NET MVC
---
...
- Full WebSharper [sitelets](https://developers.websharper.com/docs/v4.x/fs/Sitelets.md) can run alongside an ASP.NET application, sharing the same URL space, as well as the same server state, sessions, etc.
