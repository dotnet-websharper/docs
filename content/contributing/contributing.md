---
title: Contributing to WebSharper
---
...
* **.NET SDK 10.0 (or newer in the 10.x band)**. You can download it [here](https://www.microsoft.com/net/download).

### Building WebSharper from the command line

Before opening it in your IDE, you need to build WebSharper from the command line once.
